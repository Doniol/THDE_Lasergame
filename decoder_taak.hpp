...
/// \brief
/// decoder_listener class
/// \details
/// This class is created to be used as a listener for the decoder_taak class
...
private:
    ...
    /// \brief
    /// pool, flag, and listeners
    /// \details
    /// A pool and a flag for receiving data through the function decode(), also the The listeners where the decoded data will be sent to
...
public:
    ...
    void decode(std::array<int, 16> array, std::array<int, 16> test_array){
        ...
        // This is a for loop that we used for testing and debugging purposes
    ...
    /// to_int function
    /// \details
    ///Turns an array of 5 ints to an integer
